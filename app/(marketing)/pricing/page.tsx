...
export const metadata: Metadata = {
  ...
  description: `Simple, transparent pricing for PaidSoon. Start a free trial with ${publicPlans
    ...
    openGraph: {
      title: "Pricing - PaidSoon",
      description:
        "Compare Essentials, Solo, Small Business, and Business Pro plans. Transparent AUD pricing and a free trial.",
      url: "/pricing",
      type: "website",
    },
}
...
const comparisonRows: ComparisonRow[] = [
  ...
  featureRow("SpendLeak monitoring", "accounting_integrations"),
  featureRow("CostGuard alerts", "promise_to_pay_tracking"),
  featureRow("CashPlan planning", "dispute_pause"),
