...
function makeFinding(
  ...
  return {
    ...
    estimatedMonthlyCents: overrides.estimatedMonthlyCents ?? 3000,
    estimatedAnnualCents: overrides.estimatedAnnualCents ?? 36000,
    evidence: overrides.evidence ?? { supplier: "Acme", source: "expense_import" },
