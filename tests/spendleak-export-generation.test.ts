...
function makeFinding(overrides: Partial<SpendInsight> & { id: string }): SpendInsight {
  return {
    ...
    summary: overrides.summary ?? "Recurring spend detected",
    ...
    estimatedMonthlyCents: overrides.estimatedMonthlyCents !== undefined ? overrides.estimatedMonthlyCents : 2999,
    estimatedAnnualCents: overrides.estimatedAnnualCents !== undefined ? overrides.estimatedAnnualCents : 35988,
