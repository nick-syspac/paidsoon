...
| `STRIPE_STARTER_PRICE_ID` | Server | Stripe price for Essentials tier |
| `STRIPE_SOLO_PRICE_ID` | Server | Stripe price for Business Control tier |
...
| `STRIPE_BUSINESS_PRO_PRICE_ID` | Server | Stripe price for Business Pro tier (`accountant_partner` is contact-us only, no Price ID) |
