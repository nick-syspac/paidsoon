...
- Solo+ tiers can set a custom reply-to address (`custom_reply_to`) and custom sender name (`custom_sender_name`); Small Business+ tier users can send from a fully custom, verified from-domain IF `EmailSettings.resendVerified = true`.
