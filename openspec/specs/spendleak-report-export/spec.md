# spendleak-report-export Specification

## Purpose
Define tenant-scoped, analysis-only SpendLeak report export behavior for CSV and XLSX outputs from the active findings scope.
