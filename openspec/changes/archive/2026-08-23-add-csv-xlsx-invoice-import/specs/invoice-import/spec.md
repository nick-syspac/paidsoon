...
### Requirement: Legacy spreadsheet import assumptions
**Reason**: This change introduces the canonical spreadsheet-import capability as a new path rather than layering it onto a pre-existing accounting-connection model.
**Migration**: Use the new invoice-import batch and template endpoints for spreadsheet ingestion and review; do not treat spreadsheet imports as live accounting syncs.
